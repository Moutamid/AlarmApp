...
public class NotificationHelper extends ContextWrapper {
    ...
    public void sendHighPriorityNotification(String title, String body, Class activityName, int priority, int notificationId, int state) {
        if (state == 0) NotificationManagerCompat.from(this).cancel(notificationId);
        else {
